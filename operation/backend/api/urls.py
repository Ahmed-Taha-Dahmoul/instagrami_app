...
from .views import remove_unfollowed_you , remove_removed_you , instagram_stats_difference
urlpatterns = [
    ...
    path('instagram-stats-difference/' , instagram_stats_difference , name='instagram_stats_difference'),
]
